...
export function LoginPage() {
  const { user, loading, configError, signInWithOAuth, signInWithPassword, signUpWithPassword } = useAuth();
  ...
  const [destination, setDestination] = useState("/things");

  useEffect(() => {
    const params = new URLSearchParams(window.location.search);
    setDestination(params.get("next") || "/things");
  }, []);
